...
def eval_model(args):
    ...
    for line in tqdm(questions, total=len(questions)):
        ...
        for t in range(1):
            ...
            qs = make_conv_rm(line["prompt"], chosen, rejected, video_file or image_file)
            if image_file:
                ...
                file_mm = [frame_files[i] for i in sample_indices]
                messages = [
                        {
                            "role": "user",
                            "content": [
            ...
            try:
                ...
                if content_match:
                    ...
                    last_match = re.search(r"[12](?!.*[12])", critic)  # 匹配最后一个 '0' 或 '1'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/mllm_hdd/mllm_hdd/yfzhang/lmm-r1/ckpts/50k_each_class_10k_fan_128_256_3e_7_reinforce")
    parser.add_argument("--question-file", type=str, default="./inference/MM-RLHF-Reward/mm_reward_bench.jsonl")
    parser.add_argument("--image-folder", type=str, default="/mllm_hdd/mllm_hdd/yfzhang/data/alignment/")
    parser.add_argument("--answers-file", type=str, default="./inference/MM-RLHF-Reward/r1_reward.jsonl")
