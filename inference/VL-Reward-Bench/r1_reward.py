...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-folder", type=str, default="/mmu_mllm_hdd/yfzhang/data/alignment/")
    parser.add_argument("--question-file", type=str, default="inference/VL-Reward-Bench/data.jsonl")
    parser.add_argument("--answers-file", type=str, default="inference/VL-Reward-Bench/r1_reward.jsonl")
    parser.add_argument("--conv-mode", type=str, default="qwen_1_5")
    parser.add_argument("--num-chunks", type=int, default=5)
    parser.add_argument("--chunk-idx", type=int, default=4)
